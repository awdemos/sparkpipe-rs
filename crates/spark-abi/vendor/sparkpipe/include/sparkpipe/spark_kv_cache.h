#ifndef SPARKPIPE_SPARK_KV_CACHE_H
#define SPARKPIPE_SPARK_KV_CACHE_H
...
#define SPARK_KV_CACHE_ABI_VERSION 2u
...
#define SPARK_KV_CACHE_LAYOUT_MLA_COMPRESSED 2u
#define SPARK_KV_CACHE_LAYOUT_MLA_COMPRESSED_FP8_E4M3 3u
...
#define SPARK_KV_CACHE_MAX_PREFETCH_LANE_COUNT 13u
#define SPARK_KV_CACHE_PREFETCH_BLOCK_CAPACITY 1024u
...
uint32_t SparkKvCacheDsaSourceLayer(uint32_t layer_index);
