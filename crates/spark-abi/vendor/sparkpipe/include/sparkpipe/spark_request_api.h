...
#define SPARK_REQUEST_API_ABI_VERSION 7u
#define SPARK_REQUEST_API_CONFIGURATION_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApiConfiguration))
#define SPARK_REQUEST_API_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApi))
#define SPARK_REQUEST_API_SUBMIT_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApiSubmitRequest))
#define SPARK_REQUEST_API_SLOT_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApiSlot))
#define SPARK_REQUEST_API_DISPATCH_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApiDispatch))
#define SPARK_REQUEST_API_CACHE_STATE_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApiCacheState))
#define SPARK_REQUEST_API_PREFILL_DISPATCH_VIEW_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApiPrefillDispatchView))
#define SPARK_REQUEST_API_DECODE_DISPATCH_VIEW_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkRequestApiDecodeDispatchView))

#define SPARK_REQUEST_API_INVALID_HANDLE 0ull
#define SPARK_REQUEST_API_DEFAULT_PRIORITY 1000000u
...
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_PREFIX_COHORTING 0x00000004u
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_PREFILL_BATCHING 0x00000008u
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_ASYNC_JIT_KV_PREFETCH 0x00000010u
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_QUEUE_AWARE_PREFIX_CACHE_EVICTION 0x00000020u
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_DSPARK_SPECULATIVE_DECODE 0x00000040u
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_PREFER_DSPARK_SPECULATION 0x00000800u
#define SPARK_REQUEST_API_CONFIGURATION_DEFAULT_FLAGS \
...
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_MTP_COMMIT 0x00000080u
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_MTP_FORCE_ENABLE 0x00000200u
#define SPARK_REQUEST_API_CONFIGURATION_FLAG_ADAPTIVE_PIPELINE_BATCHING 0x00000100u
#define SPARK_REQUEST_API_CONFIGURATION_KNOWN_FLAGS \
    (SPARK_REQUEST_API_CONFIGURATION_DEFAULT_FLAGS | \
...
#define SPARK_REQUEST_API_REQUEST_FLAG_REALTIME 0x00000001u
#define SPARK_REQUEST_API_REQUEST_FLAG_DISABLE_SPECULATION 0x00000002u
#define SPARK_REQUEST_API_REQUEST_FLAG_KNOWN_FLAGS \
    (SPARK_REQUEST_API_REQUEST_FLAG_REALTIME | \
     SPARK_REQUEST_API_REQUEST_FLAG_DISABLE_SPECULATION)

#define SPARK_REQUEST_API_STATE_FREE 0u
#define SPARK_REQUEST_API_STATE_QUEUED_PREFILL 1u
#define SPARK_REQUEST_API_STATE_RUNNING_PREFILL 2u
#define SPARK_REQUEST_API_STATE_READY_DECODE 3u
#define SPARK_REQUEST_API_STATE_RUNNING_DECODE 4u
#define SPARK_REQUEST_API_STATE_COMPLETED 5u
#define SPARK_REQUEST_API_STATE_CANCELLED 6u
#define SPARK_REQUEST_API_STATE_WAITING_PREFIX_COHORT 7u
#define SPARK_REQUEST_API_STATE_READY_SPECULATIVE_VERIFY 8u
#define SPARK_REQUEST_API_STATE_RUNNING_SPECULATIVE_VERIFY 9u

#define SPARK_REQUEST_API_DISPATCH_KIND_NONE 0u
#define SPARK_REQUEST_API_DISPATCH_KIND_PREFILL 1u
#define SPARK_REQUEST_API_DISPATCH_KIND_DECODE_BATCH 2u
#define SPARK_REQUEST_API_DISPATCH_KIND_PREFILL_BATCH 3u
#define SPARK_REQUEST_API_DISPATCH_KIND_SPECULATIVE_VERIFY_BATCH 4u

#define SPARK_REQUEST_API_DISPATCH_FLAG_JIT_PREFETCHED_KV 0x00000001u
#define SPARK_REQUEST_API_DISPATCH_FLAG_PRIORITY_PREEMPTED_QUEUE 0x00000002u
#define SPARK_REQUEST_API_DISPATCH_FLAG_PREFIX_COHORT 0x00000004u
#define SPARK_REQUEST_API_DISPATCH_FLAG_JIT_PREFETCH_PENDING 0x00000008u
#define SPARK_REQUEST_API_DISPATCH_FLAG_PREFILL_BATCH 0x00000010u
#define SPARK_REQUEST_API_DISPATCH_FLAG_PREFIX_FAMILY_SELECTED 0x00000020u
#define SPARK_REQUEST_API_DISPATCH_FLAG_DSPARK_TAP_CAPTURE 0x00000040u
#define SPARK_REQUEST_API_DISPATCH_FLAG_DSPARK_SPECULATIVE_VERIFY 0x00000080u
#define SPARK_REQUEST_API_DISPATCH_FLAG_DSPARK_CONFIDENCE_TRUNCATED 0x00000100u
#define SPARK_REQUEST_API_DISPATCH_FLAG_MTP_COMMIT 0x00000200u
#define SPARK_REQUEST_API_DISPATCH_FLAG_MTP_SPECULATIVE_VERIFY 0x00000400u
#define SPARK_REQUEST_API_DISPATCH_FLAG_MTP_TREE_VERIFY 0x00000800u
#define SPARK_REQUEST_API_MTP_MAX_DRAFT_TOKEN_COUNT 8u
#define SPARK_REQUEST_API_MTP_INITIAL_DRAFT_TOKEN_COUNT \
    SPARK_MODEL_MTP_TREE_CANDIDATE_COUNT
#define SPARK_REQUEST_API_MTP_COMMIT_EMA_DIVISOR 4
#define SPARK_REQUEST_API_MTP_COMMIT_EMA_INITIAL_MILLI 2900u
#define SPARK_REQUEST_API_MTP_SUPPRESS_THRESHOLD_MILLI 1150u
#define SPARK_REQUEST_API_MTP_REPROBE_INTERVAL 16u
#define SPARK_REQUEST_API_PREFILL_INFLIGHT_WAVE_LIMIT 12u

#define SPARK_REQUEST_API_PENDING_PREFETCH_CAPACITY 8u
#define SPARK_REQUEST_API_SLOT_HASH_SLOTS 4096u
#define SPARK_REQUEST_API_NO_SLOT UINT32_MAX

typedef uint64_t SparkRequestApiHandle;
...
typedef struct SparkRequestApiSlot
{
    ...
    uint32_t mtp_draft_token_ids[SPARK_REQUEST_API_MTP_MAX_DRAFT_TOKEN_COUNT];
} SparkRequestApiSlot;

typedef struct SparkRequestApiPendingPrefetch
{
    uint32_t active;
    uint32_t poll_count;
    uint32_t reserved0;
...
typedef struct SparkRequestApiCacheState
{
    ...
    uint64_t sequence_id;
    uint64_t last_committed_prefix_hash;
} SparkRequestApiCacheState;

typedef struct SparkRequestApiConfiguration
{
    uint32_t abi_version;
    uint32_t descriptor_bytes;
    ...
    SparkRequestApiKvPrefetchFunction kv_prefetch_function;
...
typedef struct SparkRequestApiDispatch
{
    ...
    SparkRequestApiHandle request_handles[
        SPARK_REQUEST_API_MAX_DISPATCH_REQUEST_COUNT];
    uint32_t request_slot_indices[
        SPARK_REQUEST_API_MAX_DISPATCH_REQUEST_COUNT];
    uint64_t request_ids[SPARK_REQUEST_API_MAX_DISPATCH_REQUEST_COUNT];
    uint64_t sequence_ids[SPARK_REQUEST_API_MAX_DISPATCH_REQUEST_COUNT];
    uint64_t committed_prefix_hash;
    ...
    uint32_t decode_committed_token_counts[
        SPARK_REQUEST_API_MAX_DISPATCH_REQUEST_COUNT];
} SparkRequestApiDispatch;


typedef struct SparkRequestApiPrefillDispatchLaneView
{
    ...
    const uint32_t *prompt_token_ids;
} SparkRequestApiPrefillDispatchLaneView;

typedef struct SparkRequestApiPrefillDispatchView
{
    uint32_t abi_version;
    uint32_t descriptor_bytes;
    uint32_t kind;
    ...
    uint32_t reserved0;
    uint32_t reserved1;
    SparkRequestApiPrefillDispatchLaneView lanes[
        SPARK_REQUEST_API_MAX_DISPATCH_REQUEST_COUNT];
} SparkRequestApiPrefillDispatchView;

typedef struct SparkRequestApiDecodeDispatchLaneView
{
    uint32_t request_index;
    ...
    uint32_t mtp_resolution_committed_token_count;
    uint32_t mtp_resolution_path_id;
} SparkRequestApiDecodeDispatchLaneView;

typedef struct SparkRequestApiDecodeDispatchView
{
    uint32_t abi_version;
    uint32_t descriptor_bytes;
    uint32_t kind;
    ...
    uint32_t reserved0;
    uint32_t reserved1;
    SparkRequestApiDecodeDispatchLaneView lanes[
        SPARK_REQUEST_API_MAX_DISPATCH_REQUEST_COUNT];
} SparkRequestApiDecodeDispatchView;

typedef struct SparkRequestApi
{
    uint32_t abi_version;
    uint32_t descriptor_bytes;
    uint32_t configuration_flags;
    ...
    uint32_t slot_handle_hash_heads[
        SPARK_REQUEST_API_SLOT_HASH_SLOTS];
    SparkRequestApiPendingPrefetch pending_prefetches[
        SPARK_REQUEST_API_PENDING_PREFETCH_CAPACITY];
} SparkRequestApi;
...
struct SparkRowAllocatorSlotInput;
